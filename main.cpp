...
auto prompt_continue(const char* msg, const SessionTime& study, const SessionTime& brk, bool is_break) -> bool {
    clear();
    // NOLINTNEXTLINE(cppcoreguidelines-pro-type-vararg) // ncurses API
...
auto handle_session_transition(
...
void pomodoro_event_loop(const SessionTime& pomodoro, const SessionTime& brk) // NOLINT(readability-function-cognitive-complexity) // TUI event loop is inherently complex
{
...
auto main(int argc, char* argv[]) -> int {
    ...
    SessionTime pomodoro{study_options[study_choice].minutes, study_options[study_choice].seconds};
    SessionTime brk{break_options[break_choice].minutes, break_options[break_choice].seconds};
